...
import ru.springboot.todolist.javafx.preloader.TestPreloader;

import java.util.Arrays;

/**
 * класс для "соединения" javafx со spring
 * умеет загружать стандартными средставми FXMLoader
 * Сам контроллер он берет из бина
 */
...
public abstract class JavaFxSpringIntegrator extends Application {
	...
	/**
	 * печать всех spring бинов в консоль
 	 */
