...
public abstract class SpringFxmlView implements ApplicationContextAware, Observer {
    ...
    private static final String BUNDLES_FOLDER = "TestBundle";
    ...
    /**
     * устанавливаем applicationContext, создается вначале спринг бут приложения
     *
    ...
    /**
     * .getBean тут получаем нужный контроллер
     * и с помощью setControllerFactory внедряем в FXML
     * Т.е. заместо MainController(JavaFx) будет использоваться springBean
     * Нужно, чтобы контроллеры являлись спрингБинами и они были в общем контексте спринга
     */
...
//		}
        ...
        //подключение перевода языка, добавление в паттерн наблюдатель
